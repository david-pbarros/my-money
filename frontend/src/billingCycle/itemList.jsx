        ...
        return list.map((item, index) => (
            <tr key={index}>
                ...
                <td>
                    ...
                    <button type="button" className="btn btn-danger" onClick={() => this.remove(index, item)}>
...
const mapDsispatchToProps = dispatch => bindActionCreators({ arrayInsert, arrayRemove }, dispatch);

export default connect(null, mapDsispatchToProps)(ItemList);