        ...
        return (
            <form role="form" onSubmit={handleSubmit}>
                <div className="box-body">
                    ...
                    <ItemList cols="12 6" readOnly={readOnly} list={this.props.credits} field="credits" legend="Créditos"/>
                    <ItemList cols="12 6" readOnly={readOnly} list={this.props.debts} field="debts" legend="Débitos" showStatus={true}/>
                </div>
